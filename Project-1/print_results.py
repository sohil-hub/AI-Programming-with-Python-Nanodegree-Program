...
#                                                                             
# PROGRAMMER: Mohammedsohil Shaikh
# DATE CREATED: 22nd Aug, 2022
# REVISED DATE: 24th Aug, 2022
...
def print_results(results_dic, results_stats_dic, model, 
    ...
    print(f"Pct Corr dog: {results_stats_dic['pct_correct_dogs']} Pct Corr NOTdog: {results_stats_dic['pct_correct_notdogs']}  Pct Corr Breed: {results_stats_dic['pct_correct_breed']}")
