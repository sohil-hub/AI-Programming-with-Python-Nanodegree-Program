...
# my_var = torch.FloatTensor([0., 1., 2.]).to(device)
# print(my_var)
# data_dir = '/content/drive/MyDrive/Udacity/flowers/flower_data'
...
# model, criterion, optimizer = setup_network('vgg16', 0.2, 512, 0.001, 'cpu')
